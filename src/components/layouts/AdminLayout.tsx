...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/admin/ads', icon: TrendingUp, label: 'Ads & Boost' },
      { path: '/admin/subscriptions', icon: CreditCard, label: 'Subscriptions' },
      { path: '/admin/incentives', icon: Gift, label: 'Incentives' },
      { path: '/admin/partnerships', icon: Handshake, label: 'Brand Partners' },
    ]
  },
  {
    title: 'Operations',
    items: [
      { path: '/admin/events', icon: Calendar, label: 'Events & Catering' },
